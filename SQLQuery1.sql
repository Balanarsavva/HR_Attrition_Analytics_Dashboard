...
Years_since_last_promotion INT);
 ...
 from 'C:\Users\bunny\Downloads\archive (1)\HR_Attrition_dataset.csv'
     with(
         firstrow=2,
         fieldterminator=',',
         rowterminator='\n'
...
(
	...
	Number_of_Companies_Worked_previously,Overtime,Salary_Hikein_percent,Total_working_years_exprience,
